...
class FutsalFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'anggota5' => $this->faker->firstNameMale() . ' ' . $this->faker->lastNameMale(),
            'cadangan1' => $this->faker->firstNameMale() . ' ' . $this->faker->lastNameMale(),
            'cadangan2' => $this->faker->firstNameMale() . ' ' . $this->faker->lastNameMale(),
            'cadangan3' => $this->faker->firstNameMale() . ' ' . $this->faker->lastNameMale(),
            'cadangan4' => $this->faker->firstNameMale() . ' ' . $this->faker->lastNameMale(),
            'cadangan5' => $this->faker->firstNameMale() . ' ' . $this->faker->lastNameMale(),
