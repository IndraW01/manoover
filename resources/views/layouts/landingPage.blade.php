    ...
    <div class="wrap">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mt-2 mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="#tree">About Us</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="#four">Events</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="#five">Timeline</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="#six">Sponsor</a>
                            </li>
                        </ul>
                        @auth
                            <div class="d-flex user-logged nav-item dropdown no-arrow">
                                <a href="#" class="text-white text-decoration-none bold" role="button"
                                    id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                    Halo, {{ auth()->user()->name }}
                                    <img src="{{ 'dist/landingPage/image/arrowDown.svg' }}"
                                        style="right: 13px; padding-left:7px;">
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink"
                                        ...
                                        <li>
                                            ...
                                            @else
                                                <a href="/dashboard-user" class="dropdown-item">Pembayaran <span
        ...
        <section class="two" id="two">
            ...
            <div class="content">
                <div class="warp-image one">
                    <div class="wrap" data-aos="zoom-in"><img src="{{ asset('dist/landingPage/image/foto1.svg') }}"
                            alt=""></div>
                </div>
                <div class="warp-image two">
                    <div class="wrap"data-aos="zoom-out-up" data-aos-delay="500"><img
                            src="{{ asset('dist/landingPage/image/foto21.svg') }}" alt=""></div>
                    <div class="wrap" data-aos="zoom-out-up" data-aos-delay="400"><img
                            src="{{ asset('dist/landingPage/image/foto22 (2).svg') }}" alt=""></div>
                </div>
                <div class="warp-image tree">
                    <div class="wrap" data-aos="zoom-out-up" data-aos-delay="200" d><img
                            src="{{ asset('dist/landingPage/image/foto31.svg') }}" alt=""></div>
                    <div class="wrap" data-aos="zoom-out-up" data-aos-delay="300"><img
                            src="{{ asset('dist/landingPage/image/foto32.svg') }}" alt=""></div>
                </div>
                <div class="warp-image four">
                    <div class="wrap view" data-aos="zoom-out-up" data-aos-delay="550"><img
                            src="{{ asset('dist/landingPage/image/foto5.svg') }}" alt=""></div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="wrapEvent" data-aos="fade-up">
                        ...
                        <div id="demo" class="content-wrapEvent">
                            ...
                            <p class="contentEvent2 d-none">It is one of a series of Manoover that facilitates
                                students' interests and talents in the field of sports and arts that uphold
                                sportsmanship and creativity. The Management Competition was held for a total of 4 days
                                starting from the E-Sport competition (PUBG, Valorant, Mobile Legend) on June 3rd-June
                                5th, 2022, Futsal on June 4th, 2022, and Band Audition on July 23th, 2022</p>
                ...
                <div class="col-md-6">
                    <div class="wrapEvent" data-aos="fade-up">
                        ...
                        <div id="demo2" class="content-wrapEvent2">
                            ...
                            <p class="contentEvent21 d-none">Is the highlight of all Manoover series with performances
                                from Band Featuring, Guest Star, Special Performance, Band Performance and others.
                                Management Closing Ceremony was held on July 30th, 2022. </p>
                            <a href="{{ route('closing.detail') }}" class="contentEvent31 d-none"><button>Register
                                    Now</button></a>
                        ...
                        <div class="bottom" data-aos="fade-up">
                            <div class="wrap-description">
                                ...
                                <div class="list-descripton">
                                    ...
                                    <div class="middle"></div>
                                    <div class="end">Day 1 Management Icon, Day 2 Mobile Legend, Day 1 Valorant,
                                        Futsal</div>
                                </div>
                                <br>
                                <div class="list-descripton">
                                    ...
                                    <div class="middle"></div>
                                    <div class="end">Day 2 Management Icon, Day 3 Mobile Legend, Day 2 Valorant,
                                        Pengumuman Pemenang E-Sport</div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="six" id="six">
            <div class="wrap">
                ...
                <p>Media Partner :</p>
                <div class="support">
                    <div class="list"><img src="{{ asset('dist/landingPage/image2/one1.svg') }}" alt="">
                    </div>
                    <div class="list"><img src="{{ asset('dist/landingPage/image/top1.svg') }}" alt="">
                    </div>
                    <div class="list"><img src="{{ asset('dist/landingPage/image2/one3.svg') }}" alt="">
                    </div>
                </div>
                <br>
                <div class="support">
                    <div class="list"><img src="{{ asset('dist/landingPage/image2/two1.svg') }}" alt="">
                    </div>
                </div>
                ...
                <div class="media">
                    <div class="list"><img src="{{ asset('dist/landingPage/image/bottom1.svg') }}" alt="">
                    </div>
                    <div class="list"><img src="{{ asset('dist/landingPage/image/bottom2.svg') }}" alt="">
                    </div>
                    <div class="list"><img src="{{ asset('dist/landingPage/image/bottom3.svg') }}" alt="">
                    </div>
                    <div class="list"><img src="{{ asset('dist/landingPage/image2/four4.svg') }}" alt="">
                    </div>
                    <div class="list"><img src="{{ asset('dist/landingPage/image/bottom4.svg') }}" alt="">
                    </div>
                    <div class="list"><img src="{{ asset('dist/landingPage/image2/four6.svg') }}" alt="">
                    </div>
                    <div class="list"><img src="{{ asset('dist/landingPage/image2/four7.svg') }}" alt="">
                    </div>
                    <div class="list"><img src="{{ asset('dist/landingPage/image2/four8.svg') }}" alt="">
                    </div>
                </div>
                <br>
                <div class="media">
                    <div class="list"><img src="{{ asset('dist/landingPage/image2/five1.svg') }}" alt="">
                    </div>
                    <div class="list"><img src="{{ asset('dist/landingPage/image2/five2.svg') }}" alt="">
                    </div>
                </div>
            </div>
            <br><br>
        ...
        <section class="footer">
            ...
            <div class="row">
                ...
                <div class="col-md-4 kolom">
                    ...
                    <a href="https://www.instagram.com/manoover.undip" target="_blank" class="d-flex contacts"><img
                            src="{{ asset('dist/landingPage/image/instagram.svg') }}"
                            style="width: 20px; margin-right:10px " alt="">@manoover.undip</a>
                    <a href="https://www.instagram.com/manoover.undip" target="_blank" class="d-flex contacts"><img
                            src="{{ asset('dist/landingPage/image/Google.svg') }}"
                            style="width: 20px; margin-right:10px " alt="">manooverundip@gmail.com</a>
                    <a href="https://www.instagram.com/manoover.undip" target="_blank" class="d-flex contacts"><img
                            src="{{ asset('dist/landingPage/image/WhatsApp.svg') }}"
                            style="width: 20px; margin-right:10px " alt="">081297317866 : Ken Arsyi N.R.K.</a>
                    <a href="https://www.instagram.com/manoover.undip" target="_blank" class="d-flex contacts"><img
                            src="{{ asset('dist/landingPage/image/WhatsApp.svg') }}"
                            style="width: 20px; margin-right:10px " alt="">08112728570 : Amanda Aprilya
                        Liza</a>
                </div>
                <br><br><br>
        </section>
